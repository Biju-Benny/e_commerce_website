# Generated by Django 5.0.4 on 2024-05-08 17:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('oder_status', models.IntegerField(choices=[(2, 'ORDER_PROCESSED'), (3, 'ORDER_DELIVERED'), (4, 'ORDER_REJECTED')], default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='aded_items', to='orders.order')),
